...
export default class VaccineForm extends React.Component {
  ...
  handleSubmit = async () => {
    ...
    const data = await fetch(`https://cdn-api.co-vin.in/api/api/v2/appointment/sessions/public/findByPin?pincode=${pincode}&date=${DateTime.fromSQL(date).toFormat("dd-MM-yyyy")}`);
